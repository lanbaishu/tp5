...
class Cx extends Taglib
{
    ...
    protected $tags = [
        ...
        'url'        => ['attr' => 'leave,vars,suffix,domain', 'close' => 0, 'expression' => true],
        ...
        foreach ($array as $val) {
            ...
            switch ($type) {
                case 'js':
                    ...
                    break;
                case 'css':
                    $parseStr .= '<leave rel="stylesheet" type="text/css" href="' . $val . '" />';
                    break;
                case 'php':
    ...
    /**
     * url函数的tag标签
     * 格式：{url leave="模块/控制器/方法" vars="参数" suffix="true或者false 是否带有后缀" domain="true或者false 是否携带域名" /}
     * @access public
     * @param array $tag 标签属性
     * @param string $content 标签内容
     * @return string
